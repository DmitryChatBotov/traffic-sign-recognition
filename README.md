...
| Модель | Датасет |  Precision(all) | Recall(all) | MAP50(all) | MAP50-95(all) | epochs | classes | GPU name | FPS | batcch_size |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| yolov8s| [Russian traffic sign images dataset](https://www.kaggle.com/datasets/watchman/rtsd-dataset/data) |  0.834 | 0.774 | 0.839 | 0.621| 15 | 117 | Nvidia GeForce 3050 | 36 | 1|
| yolov5s| [Russian traffic sign images dataset](https://www.kaggle.com/datasets/watchman/rtsd-dataset/data) |  0.739 | 0.46 | 0.533 | 0.385 | 15 | 117 | | Nvidia GeForce 3050 | 26 | 1|
